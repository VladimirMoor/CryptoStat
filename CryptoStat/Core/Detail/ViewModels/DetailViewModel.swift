...
class DetailViewModel: ObservableObject {
    ...
    private func createAdditionalArray(coinDetailModel: CoinDetailModel?, coinModel: CoinModel) -> [StatisticModel] {
        ...
        let marketCapChageStat = StatisticModel(title: "24h Market Cap Change", value: marketCapChange, percentageChange: marketCapPercentChange2)
        ...
        let additionalArray: [StatisticModel] = [
            hightStat, lowStat, priceChangeStat, marketCapChageStat, blockStat, hashingStat
        ]
